        ...
        <div className="w-1/4 h-full flex flex-col gap-1">
          <div className="w-full h-2/4 overflow-hidden rounded-lg">
            <img
              ...
              alt="restaurant"
              className="object-cover h-full object-center transform transition duration-700 hover:scale-110"
            />
          </div>
          <div className="w-full h-2/4 overflow-hidden rounded-lg">
            <img
              ...
              alt="restaurant"
              className="h-full object-cover object-center transform transition duration-700 hover:scale-110"
            />
          </div>
        </div>
