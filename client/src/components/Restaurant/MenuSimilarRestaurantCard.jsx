      ...
      <div className="mx-2 my-2">
        <div className="bg-white shadow rounded-md">
          ...
          <div className="flex flex-col gap-2 p-3">
            ...
            <div className="flex items-center justify-start text-sm gap-2 flex-wrap">
              <span className="flex items-center justify-between text-sm">
                <span className="flex text-xs items-center gap-1 bg-green-700 text-white px-2 py-1 rounded mr-1">
                  30 <TiStar />
                </span>
                Dining
              </span>
